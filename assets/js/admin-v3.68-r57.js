import{db,$,esc,renderRank,setConnection,serverRemaining,sleep,APP_VERSION,BUILD_ID,BACKEND_SCHEMA_REQUIRED,TEAM_FEATURE_SCHEMA_REQUIRED,applyDocumentTheme,normalizeLogoUrl}from'./common-v3.68-r57.js';
import{avatarMarkup}from'./avatars-v3.68-r57.js';
...
function loadAdminMotionAfterAuth(){
  ...
  if(!document.getElementById('adminMotionCss')){const link=document.createElement('link');link.id='adminMotionCss';link.rel='stylesheet';link.href='assets/css/motion-v3.68-r57.css?v=3.68-r57';document.head.appendChild(link);}
  import('./motion-v3.68-r57.js?v=3.68-r57').catch(()=>{});
}
