...
function playerMotion(){
  const join=q('#joinView');if(join)join.classList.add('motion-r40-entry-safe');
...
function adminMotion(){
  q('#loginView')?.classList.add('motion-r40-entry-safe');
...
document.documentElement.classList.add('motion-r40-ready');
