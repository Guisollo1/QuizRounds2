import{avatarMapMarkup,applyAvatarFrameElement,normalizeAvatarKey}from'./avatars-v3.68-r67.js';
...
/*
  r67 — navegação endurecida: spawns somente no grafo transitável principal, portas reais e corredores (door-only).
  Os nós e arestas foram revisados sobre áreas transitáveis visíveis; conexões
...
const NAV={
  office:{
    nodes:{
      ...
      k6:[52,70],md:[72,59],r0:[13,54],r1:[13,66],r2:[18,67],r3:[25,67],r4:[32,67],r5:[36,66],r6:[36,54],r7:[20,74],r8:[20,86],r9:[30,86],r10:[30,74],f0:[12,16],f1:[12,27.5],f2:[18,29.2],f3:[32,29.2],f4:[36,27.5],f5:[36,16],m0:[70,68],
    ...
    edges:[
      ...
      ['r4','r5'],['r5','r6'],['r1','r7'],['r7','r8'],['r8','r9'],['r9','r10'],['r10','r5'],['m0','mL'],['m0','mA'],['mA','mB'],['mB','mR'],['mR','mR2'],
    ...
    spawn:[
      ...
      'k1','k2','k3','k4','k5','k6','m0','mL','mA','mB','mR','mR2'
    ],
    pois:[
  ...
  laboratory:{
    nodes:{
      ...
      a1:[12,26],a2:[12,34],a3:[20,35],a4:[28,35],a5:[36,34],a6:[36,26],a7:[36,17],b0:[60,15],b1:[68,15],b2:[77,15],b3:[86,15],b4:[59,23],b5:[59,32],b6:[59,42],b7:[68,43],b8:[77,43],
      b9:[84,43],bd:[65,47],bh:[65,51],w0:[12,48],w1:[18,48],w2:[25,48],w3:[31,48],w4:[36,48],r0:[13,55],r1:[13,67],
      r2:[18,69],r3:[25,69],r4:[32,69],r5:[36,67],r6:[36,55],r7:[20,74],r8:[20,86],r9:[30,86],r10:[30,74],ld:[46,61],l0:[47,70],
    ...
    edges:[
      ...
      ['a1','a2'],['a2','a3'],['a3','a4'],['a4','a5'],['a5','a6'],['a6','a7'],['b0','b1'],['b1','b2'],['b2','b3'],['b0','b4'],['b4','b5'],['b5','b6'],['b6','b7'],
      ['b7','b8'],['b8','b9'],['b7','bd'],['bd','bh'],['bh','c6'],['w0','w1'],['w1','w2'],['w2','w3'],['w3','w4'],
      ['r0','r1'],['r1','r2'],['r2','r3'],['r3','r4'],['r4','r5'],['r5','r6'],['r1','r7'],['r7','r8'],['r8','r9'],['r9','r10'],['r10','r5'],['c4','ld'],
    ...
    spawn:[
      'c0','c1','c2','c3','c4','c5','c6','c7','c8','b0','b1','b2','b3','b4','b5','b6','b7','b8','b9',
      'l0','l1','l2','l3','l4','l5','l6','m0','mL','mA','mB','mR','mR2'
    ],
    pois:[
  ...
  industry:{
    nodes:{
      ...
      ctrl1:[55,21],ctrl2:[62,21],ctrld:[55,25],q0:[57.5,49],q1:[57.5,62],q2:[64.5,64],q3:[72.5,62],q4:[72.5,49],q5:[68,47],q6:[62,47],o0:[78.5,49],
      o1:[78.5,63],o2:[84,64],o3:[92,63],o4:[92,49],o5:[88,47],o6:[82,47],shop0:[69,22],shopA:[74,22],shop1:[80,22],shop2:[89,22],shopd:[74,26],
      shopout:[74,30],shop6:[70,37]
    },
    edges:[
      ...
      ['ctrl1','ctrl2'],['ctrl1','ctrld'],['ctrld','c3'],['q0','q1'],['q1','q2'],['q2','q3'],['q3','q4'],['q4','q5'],['q5','q6'],['q6','q0'],['o0','o1'],
      ['o1','o2'],['o2','o3'],['o3','o4'],['o4','o5'],['o5','o6'],['o6','o0'],['shop0','shopA'],['shopA','shop1'],['shop1','shop2'],['shopA','shopd'],
    ...
    spawn:[
      'c0','c1','c2','c3','c4','c5','v0','v1','v2','v3','v4','b0','b1','b2','b3',
      'ctrl0','ctrl1','ctrl2','shop0','shopA','shop1','shop2','shop6'
    ],
    pois:[
    ...
    occluders:[
      {depth:58,clip:'polygon(24% 46%,51% 46%,51% 62%,24% 62%)'},
      {depth:67,clip:'polygon(55% 43%,76% 43%,76% 67%,55% 67%)'},
      {depth:68,clip:'polygon(77% 43%,95% 43%,95% 67%,77% 67%)'},
      {depth:84,clip:'polygon(8% 64%,47% 64%,47% 93%,8% 93%)'}
    ],
    fx:[
  ...
  platform:{
    nodes:{
      ...
      n2:[55,30],n3:[63,30],n4:[72,29],n5:[82,29],w0:[37,36],w1:[37,45],w2:[37,54],w3:[37,63],w4:[37,72.5],e0:[63,35],
      e1:[63,44],e2:[63,53],e3:[63,62],e4:[63,72.5],r0:[86,34],r1:[86,44],r2:[86,54],r3:[86,64],r4:[85,73],s0:[37,74],
      s1:[45,74],s2:[53,74],s3:[60,74],s4:[68,74],s5:[76,74],s6:[85,74],d0:[50,76],d1:[50,81],d2:[50,87],d3:[54,87],
      d4:[54,81],d5:[54,76],crew0:[14,42],crew1:[22,42],crew2:[31,42],crew3:[32,49],crew4:[32,55],crew5:[32,63],
    ...
    edges:[
      ...
      ['w3','w4'],['w3','crew5'],['n3','e0'],['e0','e1'],['e1','e2'],['e2','e3'],['e3','e4'],['n5','r0'],['r0','r1'],['r1','r2'],
...
export function createAvatarCity(host,badge,{maxActors=100}={}){
  ...
  function pointForActor(actor,nodeKey){
    ...
    const spread=tight?0:(density==='high'?.78:(density==='medium'?.62:.46));
    const ox=((actor.slot%3)-1)*spread,oy=((Math.floor(actor.slot/3)%3)-1)*spread*.58;
  ...
  function setPosition(actor,nodeKey,{instant=false}={}){
    ...
    actor.el.style.setProperty('--city-x',`${actor.x.toFixed(2)}%`);actor.el.style.setProperty('--city-y',`${actor.y.toFixed(2)}%`);actor.el.style.zIndex=String(2000+Math.round(actor.y*10));
  ...
  function mascotAnchor(scene){
    const anchors={office:[[10,76,'right'],[90,67,'left'],[50,90,'up']],laboratory:[[10,73,'right'],[90,70,'left'],[53,90,'up']],industry:[[10,70,'right'],[90,61,'left'],[52,90,'up']],platform:[[10,73,'right'],[90,72,'left'],[52,90,'up']]};
  ...
  function mascotTick(now){
    ...
    (city.querySelector('.city-walkers')||city.querySelector('.city-map-viewport')||city).append(mascotEl);requestAnimationFrame(()=>mascotEl?.classList.add('show'));
